      ...
      <table className="w-full bg-white border border-gray-300 rounded-lg text-gray-600">
        <thead className="bg-gray-300">
          <tr className="grid grid-cols-4">
            <th className="py-2 px-4 border-b flex items-center justify-center">Госномер</th>
            <th className="py-2 px-4 border-b flex items-center justify-center">Модель</th>
            <th className="py-2 px-4 border-b flex items-center justify-center">Год</th>
        ...
        <tbody>
          {filteredVehicles.length === 0 ? (
            <tr className="grid grid-cols-4">
              <td colSpan={4} className="py-4 px-4 text-center text-gray-500 col-span-4">
                {(plateSearch || modelSearch || statusFilter !== 'all') 
